...
a&&c&&caches.delete(n)})})}function e(t){return new RegExp(t)}function n(t,e){return!!e.find(function(e){return e.test(decodeURI(t))})}self.CACHE_BUSTER="1661425381728|0.8155953597691132",self.addEventListener("install",function(t){return self.skipWaiting()}),self.addEventListener("activate",function(t){return self.clients.claim()})
