...
return n=void 0===n?1:n,"object"!=typeof t&&(t={message:e||"unknown error"}),void 0===t.code&&(t.code=n),t}function a(e){return o(e,0)}e.getVersion=function(){return n},e.initialize=function(n,u,s){function f(e){s&&s(o(e))}function d(e){return r.isSupported(window)?e.packageUrl?"https://assets17.freshservice.com/a/assets/external-js/skype-web-sdk-dc6b49639e55c1e7d22f3752771d9095.js":null:e.packageUrlUnsupportedBrowser?e.packageUrlUnsupportedBrowser:void f(a("This browser is unsupported"))}function p(t){if(t.packageUrl){var r=(new Date).getTime(),o={}
...
return{isSupported:function(e){return!!function(e){return e.navigator.userAgent.indexOf("SkypeShell")>-1}(e)||!function(e){var n=function(e){var n=-1,t=e.navigator.userAgent||""
return t.indexOf("Chrome/")>-1&&t.indexOf("Safari/")>-1&&-1===t.indexOf("Edge/")&&new RegExp("Chrome/([0-9]{1,}[.0-9]{0,})").exec(t)&&(n=parseFloat(RegExp.$1)),n}(e)
return n>-1&&43>n}(e)&&!function(e){var n=function(e){var n=-1,t=e.navigator.userAgent||""
return t.indexOf("Firefox/")>-1&&t.indexOf("Gecko/")>-1&&-1===t.indexOf("Opera")&&-1===t.indexOf("Trident")&&new RegExp("Firefox/([0-9]{1,}[.0-9]{0,})").exec(t)&&(n=parseFloat(RegExp.$1)),n}(e)
return n>-1&&40>n}(e)&&!function(e){var n=function(e){var n=-1,t=e.navigator.userAgent||""
return"Microsoft Internet Explorer"===(e.navigator.appName||"")&&new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(t)&&(n=parseFloat(RegExp.$1)),n}(e)
return n>-1&&10>n}(e)&&!function(e){var n=function(e){var n=-1,t=e.navigator.userAgent||""
return t.indexOf("Safari/")>-1&&-1===t.indexOf("Chrome")&&new RegExp("Version/([0-9]{1,}[.0-9]{0,})").exec(t)&&(n=parseFloat(RegExp.$1)),n}(e)
